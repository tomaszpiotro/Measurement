...
public class SerialTransmission2 implements SerialPortEventListener, Transmission {
    ...
    public SerialTransmission2(final BlockingQueue<ControllerEvent> queue)
    {
        this.queue = queue;
    }
    ...
    {
        return SerialTransmission2.PORT_NAMES;
    }
